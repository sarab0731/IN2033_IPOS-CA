...
CREATE TABLE `payment_reminders` (
  ...
  CONSTRAINT `payment_reminders_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer_accounts` (`customer_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `payment_reminders_ibfk_2` FOREIGN KEY (`invoice_id`) REFERENCES `invoices` (`invoice_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `payment_reminders_chk_1` CHECK ((`reminder_type` in (_utf8mb4'FIRST',_utf8mb4'SECOND'))),
  CONSTRAINT `payment_reminders_chk_2` CHECK ((`reminder_status` in (_utf8mb4'PENDING',_utf8mb4'SENT',_utf8mb4'NO_NEED')))
